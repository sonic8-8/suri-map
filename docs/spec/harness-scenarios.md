...
| 하네스 geometry/GPS 기준 좌표 | SC-04, SC-05, SC-06 | 기준 지도 envelope는 EPSG:4326 bbox `minLon=126.647507`, `minLat=35.052595`, `maxLon=127.017482`, `maxLat=35.256837`이다. 최소 Polygon 면적은 `400m2`이고 좌표 precision은 소수 6자리 canonical 값을 기준으로 한다. 정상 `overall_search_area` fixture는 `[[126.904000,35.158000],[126.923000,35.158000],[126.923000,35.173000],[126.904000,35.173000],[126.904000,35.158000]]`, 정상 `search_area` fixture는 `[[126.910000,35.160000],[126.918000,35.160000],[126.918000,35.166000],[126.910000,35.166000],[126.910000,35.160000]]`, 정상 marker fixture는 `[126.913400,35.163100]`를 쓴다. 실패 좌표 fixture는 `coord-outside-envelope=[127.200000,35.163100]`, `coord-latlon-swapped=[35.163100,126.913400]`, `polygon-unclosed`, `polygon-self-intersecting`, `polygon-too-small-under-400m2`, `point-null-nan`, `precision-over-6dp=[126.9134007,35.1631007]`로 고정하고 SC-04/05/06 geometry red test가 이 이름을 참조한다 |
