 ...
 *
 * <p>OP 자체, bootstrap, transition, guard, idempotency fixture는 각 전용 fixture 클래스를 사용한다.
 */
public final class OpAssignmentFixtures {
  ...
  public static final List<String> OP_ASSIGNMENT_STATUSES =
      List.of("ACTIVE", "REPLACED", "CANCELLED");

  /** op_assignment.assignment_type에 실제 저장될 수 있는 값. */
  public static final List<String> OP_ASSIGNMENT_TYPES = List.of("TEAM_PHONE", "PATROL_CAR_PHONE");

  /** AssignmentQuery.byOp 결과 행이 유지해야 하는 필드 목록. */
  public static final List<String> ASSIGNMENT_QUERY_ROW_SHAPE =
      List.of(
          "assignmentId",
          "incidentId",
          "opId",
