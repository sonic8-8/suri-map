...
public final class CurrentOpConsumerFixtures {
    ...
    public static final List<String> CURRENT_OP_CONSUMERS = List.of(
    ...
    public static final List<String> FORBIDDEN_S8_OWNER_WRITES = List.of(
    ...
    public static List<CurrentOpConsumerProbe> currentOpConsumerProbes() {
        return CURRENT_OP_CONSUMERS.stream()
                .map(consumer -> new CurrentOpConsumerProbe(
                        consumer,
    ...
    public record CurrentOpConsumerProbe(
            String consumer,
            UUID opId,
            int sequenceNo,
            long version
