 ...
 *
 * <p>OP1 current OP, OP2 전환 후 상태, OperationalPeriodQuery row shape에서 공유한다.</p>
 */
public final class OperationalPeriodFixtures {
    ...
    public static final List<String> OP_REASON_PERSISTED = List.of(
            "BOOTSTRAP",
            "SHIFT_CHANGE",
            "RE_SEARCH",
            "NEW_AREA",
    ...
    public static final List<String> OP_REASON_MANUAL_CREATE = List.of(
            "SHIFT_CHANGE",
            "RE_SEARCH",
            "NEW_AREA",
            "OTHER"
