...
public final class OpTransitionFixtures {
  ...
  public static final List<String> SC10_BOARD_PROBE_SLOTS =
      List.of("op_toggle", "op_history", "handover_status");
  ...
  /** OP 전환 REST 응답 비교 모델. */
  public record OpTransitionRestResponse(UUID id, String status, long version, int sequenceNo) {}
