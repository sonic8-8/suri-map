 ...
 *
 * <p>S3-1/S5 field write contract test가 current OP 필수/불일치 실패를 재현할 수 있게 한다.
 */
public final class CurrentOpGuardMock {
  ...
  public CurrentOpGuardFixtures.CurrentOpGuardDecision requireCurrentOp(
      UUID incidentId, UUID requestedOpId) {
