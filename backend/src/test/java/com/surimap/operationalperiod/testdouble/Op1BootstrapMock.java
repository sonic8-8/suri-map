 ...
 *
 * <p>L1은 INCIDENT_CREATED fixture를 넣어 OP1 completion과 current/list OP 응답을 소비한다.
 */
public final class Op1BootstrapMock {

  private final Map<UUID, OpBootstrapFixtures.Op1BootstrapCompletion> completions =
      new LinkedHashMap<>();
  private int publishRequestCount;

  public OpBootstrapFixtures.Op1BootstrapCompletion handle(
      OpBootstrapFixtures.IncidentCreatedEvent event) {
    ...
    OpBootstrapFixtures.Op1BootstrapCompletion completion =
        new OpBootstrapFixtures.Op1BootstrapCompletion(
            event.incidentId(),
