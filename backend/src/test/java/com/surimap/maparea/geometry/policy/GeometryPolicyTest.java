...
class GeometryPolicyTest {
    ...
    void bbox_내부_좌표는_true다() {
        assertThat(policy.containsLonLat(
    ...
    private void assertInvalidPolicy(
        ...
        assertThatThrownBy(() -> new GeometryPolicy(
                srid,
                crs,
                coordinateOrder,
                new BigDecimal("126.900000"),
