...
class GeometryValidatorTest {
    ...
    void point를_6자리_canonical_scale로_정규화한다() {
        List<BigDecimal> point = List.of(
                new BigDecimal("126.9565"),
                new BigDecimal("37.5712")
        );
    ...
    void 소수점_7자리_좌표는_6자리로_반올림한다() {
        List<BigDecimal> result = validator.validateAndCanonicalizePoint(
                GeometryFixtures.overPrecisionPoint()
        );
    ...
    void 반올림_이후에도_bbox_밖이면_invalid_geometry다() {
        List<BigDecimal> point = List.of(
                new BigDecimal("127.0800005"),
                new BigDecimal("37.5712000")
        );
    ...
    void 좌표_수가_4개_미만인_ring은_invalid_geometry다() {
        List<List<BigDecimal>> ring = List.of(
    ...
    void ring의_연속_중복_좌표를_제거한다() {
        ...
        assertThat(result).hasSize(4);
        assertThat(result.get(0)).containsExactly(new BigDecimal("126.950000"), new BigDecimal("37.550000"));
        assertThat(result.get(1)).containsExactly(new BigDecimal("126.960000"), new BigDecimal("37.550000"));
        assertThat(result.get(2)).containsExactly(new BigDecimal("126.960000"), new BigDecimal("37.560000"));
        assertThat(result.get(3)).containsExactly(new BigDecimal("126.950000"), new BigDecimal("37.550000"));
    }
