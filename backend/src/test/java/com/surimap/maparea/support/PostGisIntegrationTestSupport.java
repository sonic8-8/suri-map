...
/** PostGIS 기반 Spring Boot 통합 테스트 공통 설정. PostGIS extension, mapper SQL, TypeHandler 작동 검증 테스트용 */
...
public abstract class PostGisIntegrationTestSupport {
  ...
  @BeforeEach
  void cleanS2Tables() {
    jdbcTemplate.execute("TRUNCATE TABLE search_area_history, search_area");
  }
}
