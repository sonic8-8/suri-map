...
VALUES
    ('22222222-2222-2222-2222-222222220001', 'dev-precinct-cmd-phone-01', 'Precinct commander phone', '11111111-1111-1111-1111-111111110001', 'ACTIVE'),
    ('22222222-2222-2222-2222-222222220002', 'dev-alpha-cmd-phone-01', 'Missing commander phone', '11111111-1111-1111-1111-111111110002', 'ACTIVE'),
    ('22222222-2222-2222-2222-222222220003', 'dev-support-cmd-phone-01', 'Support commander phone', '11111111-1111-1111-1111-111111110003', 'ACTIVE'),
    ('22222222-2222-2222-2222-222222220004', 'dev-precinct-phone-01', 'Precinct team phone', '11111111-1111-1111-1111-111111110004', 'ACTIVE'),
    ('22222222-2222-2222-2222-222222220005', 'dev-support-phone-01', 'Support team phone', '11111111-1111-1111-1111-111111110005', 'ACTIVE'),
    ('22222222-2222-2222-2222-222222220006', 'dev-support-car-01', 'Support patrol phone', '11111111-1111-1111-1111-111111110006', 'ACTIVE'),
    ('22222222-2222-2222-2222-222222220007', 'dev-precinct-car-01', 'Precinct patrol phone', '11111111-1111-1111-1111-111111110007', 'ACTIVE'),
    ('22222222-2222-2222-2222-222222220008', 'dev-alpha-phone-01', 'Missing team phone', '11111111-1111-1111-1111-111111110008', 'ACTIVE'),
    ('22222222-2222-2222-2222-222222220009', 'dev-purge-check-phone-01', 'Purge check phone', '11111111-1111-1111-1111-111111110009', 'ACTIVE')
ON CONFLICT (id) DO UPDATE SET
