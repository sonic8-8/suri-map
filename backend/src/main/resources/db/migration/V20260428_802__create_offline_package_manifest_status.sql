CREATE TABLE IF NOT EXISTS offline_package_manifest (
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_offline_package_manifest_incident_version
    ON offline_package_manifest (incident_id, manifest_version);

CREATE TABLE IF NOT EXISTS offline_package_installation (
    id VARCHAR(80) PRIMARY KEY,
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_offline_package_installation_manifest_phone
    ON offline_package_installation (offline_package_manifest_id, police_phone_id);

CREATE INDEX IF NOT EXISTS idx_offline_package_installation_status
