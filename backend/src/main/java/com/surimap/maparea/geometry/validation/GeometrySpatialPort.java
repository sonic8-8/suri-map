 ...
 *
 * <p>좌표 구조나 ring 닫힘처럼 Java 코드만으로 확인 가능한 검증은 {@link GeometryValidator}가 담당한다.
 *
 * <p>이 포트는 실제 면적, Polygon 포함 관계, Polygon 간 면적 겹침처럼 PostGIS 공간 연산이 필요한 검증을 담당한다.
 */
